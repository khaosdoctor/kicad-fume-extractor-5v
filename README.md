...
```
fume Extractor.kicad_pro    KiCad project file
fume Extractor.kicad_sch    Schematic
fume Extractor.kicad_pcb    PCB layout
sym-lib-table                Project-local symbol library table
bom/ibom.html                 Interactive HTML BOM (also regenerated by KiBot)
kibot.yaml                     KiBot configuration (see below)
```
